<script>
  ...
  const modeLabels = { restore:'AI Restore', shadow_remove:'Shadow Remove', shadow_effective_bg:'Shadow BG Est.', shadow_iterative:'Shadow Iterative', shadow_so:'Shadow SO', shadow_so_aggressive:'Shadow SO Aggr.', enhance:'AI Enhance', magic_enhance:'Magic Enhance', binarize:'Binarize', color_binarize:'Color Binarize', cleanup:'Full Cleanup', clahe:'CLAHE', denoise:'Denoise', sharpen:'Sharpen', deskew:'Deskew' }
