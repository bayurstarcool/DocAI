<script>
  ...
  const serverPresets = [
    ...
    { id: 'v3', name: 'V3 Safe Fine-tune', note: 'Anti artefak: Charbonnier, perceptual kecil, identity/color kuat.', epochs: 30, batchSize: 5, size: 768, lr: 0.000005, workers: 4, perceptualWeight: 0.005, ssimWeight: 0.25, shadowLossWeight: 1.5, illuminationWeight: 0.20, maskLossWeight: 0.25, gradientWeight: 0.05, colorWeight: 0.15, identityWeight: 1.0, colorPreservationWeight: 0.9, textWeight: 0.2, nonShadowWeight: 0.5, warmupEpochs: 3, earlyStopPatience: 12, minDelta: 0.0001, gradClipNorm: 1.0, resumeBest: true }
  ]

  let selectedPreset = 'v3'
  const config = { epochs: 30, batchSize: 5, size: 768, lr: 0.000005, baseChannels: 32, workers: 4, perceptualWeight: 0.005, ssimWeight: 0.25, shadowLossWeight: 1.5, illuminationWeight: 0.20, maskLossWeight: 0.25, gradientWeight: 0.05, colorWeight: 0.15, identityWeight: 1.0, colorPreservationWeight: 0.9, textWeight: 0.2, nonShadowWeight: 0.5, warmupEpochs: 3, earlyStopPatience: 12, minDelta: 0.0001, gradClipNorm: 1.0, resumeBest: true, device: 'cuda', maxTrainSamples: 0, maxValSamples: 0, maxEvalSamples: 0 }
